...
the grouped workflow retain local widget values such as 97 frames / 25 fps, but
their inputs are linked to the top-level duration/frame-rate controls and those
local values are therefore not the effective saved recipe.
